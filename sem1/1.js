...
let degreesCelsius = prompt('Enter temperature in degrees Celsius');

let degreesFarenheit = (9 / 5) * degreesCelsius + 32;

alert (`Цельсий: ${degreesCelsius}, Фаренгейт: ${degreesFarenheit}`);